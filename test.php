//connexion qui fonctionne en principe:
<?php
    try 
    {
        $bdd = new PDO("mysql:host=127.0.0.1;dbname=bocal_vroomvroombids;port=8889", "root", "root");
    }
...
je veux que tu enleves les script, boostrap, tout le superflux, et qu'il reste juste ce qu'il marche pour que la connexion se fasse et la deconnexion aussi